...
:END:
:LOGBOOK:
- State "TODO"       from              [2019-07-12 Fri 08:11]
:END:
...
** OODA is a strange loop
:PROPERTIES:
:EXPORT_HUGO_BUNDLE: ooda-is-a-strange-loop
:EXPORT_HUGO_MENU: :parent blog
:END:
*** TODO OODA is a strange loop
...
**** The OODA loop
**** Strange loops
The key understanding uncertainty is understanding uncertainty
* Quotes
:PROPERTIES:
